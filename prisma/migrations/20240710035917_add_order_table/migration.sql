...
-- AddForeignKey
ALTER TABLE "Order" ADD CONSTRAINT "Order_restautrantId_fkey" FOREIGN KEY ("restautrantId") REFERENCES "Restaurant"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
